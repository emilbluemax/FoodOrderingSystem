        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/rest.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>								  
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >₹<?php echo $product['price']; ?></span>
										  <input class="b-r-0" type="number" name="quantity"  style="margin-left:30px;" value=1 size="2" required min="1"/>
                    ...
                    <a href="index.php"  class="btn btn-success btn-lg active">Search for more Dishes</a>
                </div>
