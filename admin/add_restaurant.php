       ...
       <div class="header">
        ...
        <div class="page-wrapper" style=" background-color: 	#E0FFFF">
            ...
            <div class="container-fluid">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" pattern="[0-9]{10}" name="phone" class="form-control" >
                                                   </div>
                                            </div>
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="c_hr" class="form-control custom-select" data-placeholder="Choose a Category" >
                                                        ...
                                                        <option value="11pm" selected>11pm</option>
					...
					<footer class="footer"> Online Food Ordering System Made by TEAM 1 </footer>
                </div>
