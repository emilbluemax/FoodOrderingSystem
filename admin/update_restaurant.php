...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/logo_main_white.jpeg" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                <div class="navbar-collapse">
                    <ul class="navbar-nav my-lg-0">                                                       
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/bookingSystem/admin_bitemoji.jpg" alt="user" class="profile-pic" /></a>
        ...
        <div class="left-sidebar" style=" background-color: #E6E6FA">
       
            <div class="scroll-sidebar" style=" background-color: #E6E6FA">
    
                <nav class="sidebar-nav" style=" background-color: #E6E6FA">
                   <ul id="sidebarnav">
        ...
        <div class="page-wrapper"  style=" background-color: 	#E0FFFF">
            ...
            <div class="container-fluid">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="url" name="url" class="form-control form-control-danger" value="<?php echo $row['url'];  ?>" placeholder="http://example.com">
                                                    </div>
                                            </div>
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="c_hr" class="form-control custom-select"    data-placeholder="Choose a Category" >
														...
														<option value="8pm" selected>8pm</option>
                                                    </select>
                                                </div>
                                            </div>
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select"  data-placeholder="Choose a Category" tabindex="1">
														...
														<option value="24hr-x7" selected>24hr-x7</option>
                                                    </select>
                                                </div>
                                            </div>
					...
					<footer class="footer">  Online Food Ordering System 
            Made by TEAM 1</footer>
                </div>
