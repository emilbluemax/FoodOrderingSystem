                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="admin">Admin Login <span class="sr-only">(current)</span></a> </li>
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        ...
                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="search" id="search" placeholder="I would like to eat...." > </div>
                            </div>
                            <button  type="submit" id="submit" name="submit" class="btn theme-btn btn-lg">Search food</button>
                        </form>
                    </div>
                    <div class="steps">
        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
						<?php 	
                        $name=$_GET['name'];			
                        if(isset($name) or !isset($name)){
						$query_res= mysqli_query($db,"select * from dishes where title like '%$name%' or slogan like '%$name%'"); 
                                ...
                                if(!$s=mysqli_num_rows($query_res)){
                                echo '<div> Your search -<b>'.$name.'</b>- did not match any documents.
                                <br>
                                Suggestions:
                                <br>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#"> <img src="images/gpay.jpg" alt="Google pay" width=28> </a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: 080661 8661</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                    <p>Made by TEAM 1</p>
                                    <p>Emil Bluemax : PES2UG20CS431 <br> 
                                    J P Daniel Christopher : PES2UG20CS433 <br> 
                                    Karan Chouhan D : PES2UG20CS437 <br> 
                                    Shadab Kousar: PES2UG20CS459</p>
                                </div>
                    </div>
                </div>
