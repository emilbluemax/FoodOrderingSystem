...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="images/logo_main_white.jpeg">
...
<div style="margin-left:50px;">
 <form name="updateticket" style=" background-color: #E6E6FA" id="updatecomplaint" method="post"> 
